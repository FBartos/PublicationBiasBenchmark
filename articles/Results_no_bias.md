...
[no_bias](https://fbartos.github.io/PublicationBiasBenchmark/reference/dgm.no_bias.md)
data-generating mechanism with a total of 8 conditions.
...
methods](Results_no_bias_files/figure-html/unnamed-chunk-44-1.png)

![Raincloud plot showing RMSE (Root Mean Square Error) across different
methods](Results_no_bias_files/figure-html/unnamed-chunk-45-1.png)
...
methods](Results_no_bias_files/figure-html/unnamed-chunk-46-1.png)
...
![Raincloud plot showing bias across different
methods](Results_no_bias_files/figure-html/unnamed-chunk-47-1.png)
...
methods](Results_no_bias_files/figure-html/unnamed-chunk-48-1.png)
...
different
methods](Results_no_bias_files/figure-html/unnamed-chunk-49-1.png)
...
![Raincloud plot showing 95% confidence interval width across different
methods](Results_no_bias_files/figure-html/unnamed-chunk-50-1.png)
...
methods](Results_no_bias_files/figure-html/unnamed-chunk-51-1.png)
...
methods](Results_no_bias_files/figure-html/unnamed-chunk-52-1.png)
...
methods](Results_no_bias_files/figure-html/unnamed-chunk-53-1.png)
...
methods](Results_no_bias_files/figure-html/unnamed-chunk-54-1.png)
...
![Raincloud plot showing convergence rates across different
methods](Results_no_bias_files/figure-html/unnamed-chunk-70-1.png)

![Raincloud plot showing RMSE (Root Mean Square Error) across different
methods](Results_no_bias_files/figure-html/unnamed-chunk-71-1.png)
...
![Raincloud plot showing bias across different
methods](Results_no_bias_files/figure-html/unnamed-chunk-72-1.png)
...
![Raincloud plot showing bias across different
methods](Results_no_bias_files/figure-html/unnamed-chunk-73-1.png)
...
![Raincloud plot showing 95% confidence interval width across different
methods](Results_no_bias_files/figure-html/unnamed-chunk-74-1.png)
...
![Raincloud plot showing 95% confidence interval coverage across
different
methods](Results_no_bias_files/figure-html/unnamed-chunk-75-1.png)
...
![Raincloud plot showing 95% confidence interval width across different
methods](Results_no_bias_files/figure-html/unnamed-chunk-76-1.png)
...
![Raincloud plot showing positive likelihood ratio across different
methods](Results_no_bias_files/figure-html/unnamed-chunk-77-1.png)
...
![Raincloud plot showing negative likelihood ratio across different
methods](Results_no_bias_files/figure-html/unnamed-chunk-78-1.png)
...
![Raincloud plot showing Type I Error rates across different
methods](Results_no_bias_files/figure-html/unnamed-chunk-79-1.png)
...
![Raincloud plot showing statistical power across different
methods](Results_no_bias_files/figure-html/unnamed-chunk-80-1.png)
...
This report was compiled on Mon Mar 16 09:02:54 2026 (UTC) using the
