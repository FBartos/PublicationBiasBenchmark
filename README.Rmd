...
- `"MAIVE"`: Meta Analysis Instrumental Variable Estimator [@irsova2025spurious]
- `"MAN"`: Meta-Analysis of Nonaffirmative Studies [@mathur2020sensitivity]
- `"RTMA"`: Right-Truncated Meta-Analysis [@mathur2024phacking]
- `"MMPH"`: Mixture Model of P-Hacking [@moss2023modelling]
