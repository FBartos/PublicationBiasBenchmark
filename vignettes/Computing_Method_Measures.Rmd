...
- **power_test_type**: How significance is determined (`"p_value"`, `"bayes_factor"`, or `"ci"` for methods reporting only confidence intervals, i.e., the null hypothesis is rejected if the confidence interval excludes zero)
