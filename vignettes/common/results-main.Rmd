...
results_replacement <- do.call(rbind, results_conditional_list)
...
create_raincloud_plot(results_conditional, "convergence", "Convergence", ylim_range = c(0, 1)) +
...
create_raincloud_plot(results_conditional, "bias", "Bias", ylim_range = c(-0.5, 0.5), reference_line = 0)
```
...
create_raincloud_plot(results_conditional, "rmse", "RMSE", ylim_range = c(0, 0.5), reference_line = 0)
```
...
create_raincloud_plot(results_conditional, "coverage", "95% CI Coverage", ylim_range = c(0, 1), reference_line = 0.95) +
  scale_y_continuous(labels = scales::percent)
```
...
create_raincloud_plot(results_conditional[results_conditional$H0,], "power", "Type I Error Rate", ylim_range = c(0, 1), reference_line = 0.05) +
  scale_y_continuous(labels = scales::percent)
```
...
create_raincloud_plot(results_conditional[!results_conditional$H0,], "power", "Power", ylim_range = c(0, 1)) +
  scale_y_continuous(labels = scales::percent)
```
...
```{r fig.height = 8, echo=FALSE, warning=FALSE, fig.alt="Raincloud plot showing convergence rates across different methods with replacement"} 
create_raincloud_plot(results_replacement, "convergence", "Convergence", ylim_range = c(0, 1)) +
  scale_y_continuous(labels = scales::percent)
```

### Bias

```{r fig.height = 8, echo=FALSE, warning=FALSE, fig.alt="Raincloud plot showing bias across different methods with replacement"} 
create_raincloud_plot(results_replacement, "bias", "Bias", ylim_range = c(-0.5, 0.5), reference_line = 0)
```
...
```{r fig.height = 8, echo=FALSE, warning=FALSE, fig.alt="Raincloud plot showing RMSE across different methods with replacement"} 
create_raincloud_plot(results_replacement, "rmse", "RMSE", ylim_range = c(0, 0.5), reference_line = 0)
```
...
```{r fig.height = 8, echo=FALSE, warning=FALSE, fig.alt="Raincloud plot showing 95% confidence interval coverage across different methods with replacement"} 
create_raincloud_plot(results_replacement, "coverage", "95% CI Coverage", ylim_range = c(0, 1), reference_line = 0.95) +
  scale_y_continuous(labels = scales::percent)
```

### Type I Error Rate

```{r fig.height = 8, echo=FALSE, warning=FALSE, fig.alt="Raincloud plot showing Type I Error rates across different methods with replacement"} 
create_raincloud_plot(results_replacement[results_replacement$H0,], "power", "Type I Error Rate", ylim_range = c(0, 1), reference_line = 0.05) +
  scale_y_continuous(labels = scales::percent)
```

### Power

```{r fig.height = 8, echo=FALSE, warning=FALSE, fig.alt="Raincloud plot showing statistical power across different methods with replacement"} 
create_raincloud_plot(results_replacement[!results_replacement$H0,], "power", "Power", ylim_range = c(0, 1)) +
  scale_y_continuous(labels = scales::percent)
```
