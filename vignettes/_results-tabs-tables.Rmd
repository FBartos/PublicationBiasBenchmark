...
`r if (!common_scale) "Methods are compared using the average of repetition-wise ranks. Direct comparison using the average bias is not possible because the data generating mechanisms differ in the outcome scale. See a DGM-specific results (or subresults)."`
...
`r if (!common_scale) "Methods are compared using the average of repetition-wise ranks. Direct comparison using the average rmse is not possible because the data generating mechanisms differ in the outcome scale. See a DGM-specific results (or subresults)."`
