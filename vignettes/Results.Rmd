...
```{r fig.height = 8, echo=FALSE, warning=FALSE} 
create_raincloud_plot(df, "coverage", "95% CI Coverage", ylim_range = c(0, 1), reference_line = 0.95) +
  scale_y_continuous(labels = scales::percent)
```
...
```{r fig.height = 8, echo=FALSE, warning=FALSE} 
create_raincloud_plot(df[df$H0,], "power", "Type I Error Rate", ylim_range = c(0, 1), reference_line = 0.05) +
  scale_y_continuous(labels = scales::percent)
```
...
```{r fig.height = 8, echo=FALSE, warning=FALSE} 
create_raincloud_plot(dfr, "coverage", "95% CI Coverage", ylim_range = c(0, 1), reference_line = 0.95) +
  scale_y_continuous(labels = scales::percent)
```
...
```{r fig.height = 8, echo=FALSE, warning=FALSE} 
create_raincloud_plot(dfr[dfr$H0,], "power", "Type I Error Rate", ylim_range = c(0, 1), reference_line = 0.05) +
  scale_y_continuous(labels = scales::percent)
```
