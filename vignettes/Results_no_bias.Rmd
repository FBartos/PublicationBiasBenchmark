...
## Average Performance Tables{.tabset .tabset-fade .tabset-pills}
...
DT::formatRound(
  DT::datatable(tb, options = list(
    ...
    initComplete = DT::JS(
      ...
      "  setTimeout(function() {",
      "    $(this.api().table().container()).trigger('resize');",
      "  }, 100);",
      "}"
    )
  )), 
