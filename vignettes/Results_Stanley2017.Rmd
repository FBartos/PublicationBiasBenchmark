...
this_tables_conditional <- make_table_summary(results_conditional[results_conditional$condition_id %in% conditions$condition_id[conditions$environment == "Cohens_d"],])
this_tables_replacement <- make_table_summary(results_replacement[results_conditional$condition_id %in% conditions$condition_id[conditions$environment == "Cohens_d"],])
...
```{r, include = FALSE}
# compute average performance
this_tables_conditional <- make_table_summary(results_conditional[results_conditional$condition_id %in% conditions$condition_id[conditions$environment == "LogOR"],])
this_tables_replacement <- make_table_summary(results_replacement[results_conditional$condition_id %in% conditions$condition_id[conditions$environment == "LogOR"],])
